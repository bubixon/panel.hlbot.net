            ...
            <div class="col-md-12 mx-auto">
                <div class="ibox">
                    <div class="ibox-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group m-b-10 btn-rounded">
                                                    <a href="<?php echo base_url('/admin/support/view/' . $ticket['id']); ?>" role="button" class="btn btn-success"><i class="fas fa-location-arrow"></i> Otwórz</a>
                                                    <a href="<?php echo base_url('/admin/support/close/' . $ticket['id']); ?>" role="button" class="btn btn-danger"><i class="fas fa-times-circle"></i> Zamknij</a>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                        ...
                        <?php elseif ($page == "create" || is_numeric($id)): ?>
                                ...
                                <div class="col-md-10 mx-auto mt-2">
                                    <div class="card">
                                        <div class="p-2 card-body">
                                            ...
                                            <div><small class="opacity-60"><i class="far fa-clock"></i> <?php echo $replice['date']; ?> napisał <?php echo $user['email']; ?></small></div>
                                        </div>
                                    </div>
                                </div>
                            <?php else: ?>
                        ...
                        <div class="ibox-body">
                            <div class="form-horizontal">
                                <div class="d-block card-footer"><?php echo form_open(base_url('/admin/support/view/') . $id, array('class' => 'align-items-center')); ?><div class="d-flex form-control-lg input-group"><div class="d-flex input-group-prepend"><span class="input-group-text"><i class="tim-icons icon-pencil"></i></span></div><input placeholder="Wiadomość..." type="text" name="desc" class="form-control"><button class="btn-simple ml-2 btn btn-primary"><i class="fas fa-location-arrow"></i> Wyślij</button></div><?php echo form_close(); ?></div>
                                </form>
                            </div>
                            <?php endif; ?>
                        </div>
